        ...
        <div className="container">
          ...
          >
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <Link to="/our-classes"></Link><a class="nav-link pl-4 text-white font-weight-bold" href>
                  Our Classes
                </a>
              </li>
        ...
        {/* Navbar */}
          <div className="container">
              ...
              <div className="d-flex justify-content-center">
                  <h1 className="text-white font-weight-bold text-uppercase" id="margin-top">Advance Gym</h1>
              </div>
